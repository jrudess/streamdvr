...
class PostProcess {
    ...
    convert() {
        ...
        const completeFile = this.uniqueFileName(completeDir, capInfo.filename, fileType) + "." + fileType;
        ...
        if (this.dvr.config.tui.enable && this.dvr.tui) {
            this.dvr.tui.render(true, site);
        }
