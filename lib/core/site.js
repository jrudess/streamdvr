        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (options.pause) {
                if (this.streamerList.has(id.uid)) {
                    ...
                    const toggle = yield this.togglePause(streamer, options);
                    if (toggle) {
                        dirty = true;
                        this.render(true);
                    }
                ...
                const added = yield this.addStreamer(id, list, options);
                if (added) {
    ...
    updateStreamers(list, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const entry of list) {
                dirty = (yield this.updateList(entry, { add: options.add, pause: 0, isTemp: false, init: options.init })) || dirty;
            }
            return dirty;
        });
    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this.streamerList.has(id.uid)) {
                ...
                if (!options || !options.init) {
                    yield this.refresh(this.streamerList.get(id.uid), options);
                }
            }
            return added;
        });
    ...
    refresh(streamer, options) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.dvr.tryingToExit && this.streamerList.has(streamer.uid)) {
                if (!options || !options.init) {
                    yield this.checkStreamerState(streamer);
                }
            }
        });
    }
