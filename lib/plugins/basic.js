...
class Basic extends site_1.default {
    ...
    updateList(nm, options) {
        const _super = Object.create(null, {
            updateList: { get: () => super.updateList }
        });
        return __awaiter(this, void 0, void 0, function* () {
            return _super.updateList.call(this, { nm: nm, uid: nm }, options);
        });
    }
    createListItem(id) {
        const listItem = [];
                ...
                for (const item of this.config.streamers) {
                    if (item[0] === streamer.uid) {
                        if (streamer.paused) {
                            ...
                            yield this.refresh(streamer, options);
                        }
                        else {
    ...
    checkStreamerState(streamer, options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield _super.checkStreamerState.call(this, streamer, newoptions);
            if (stream.status) {
                if (streamer.paused) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                for (const item of serRuns) {
                    yield this.checkBatch(item, options);
                }
                return true;
            }
            catch (err) {
